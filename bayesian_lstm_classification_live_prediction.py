...
import bayesian_lstm_classification as nn
import os 
import keras
...
n_lags = 3#lookback window length
...
bayesian_threshold = [10] #obtained from best validation set model 
p_out = 3 #how many periods out do you want to perdict?
plot=True



#load selected model
name = 'LGS3-EPCHS101-BTCH512-NRNS25-LAY1-BL1_0.00,L2_0.00-KL1_0.00,\
