...
# at what return is profit taken in period. #the price has to be strictly higher (lower) for
# a sell (buy) order to be assumed filled
...
#load selected model
name = 'LGS1-EPCHS200-BTCH512-NRNS256-LAY3-BL1_0.00,L2_0.00-KL1_0.00,L2_0.00-RL1_0.00,L2_0.00-LR0.0010-LRD0.0000-DO0.50-PTT0.0005'
...
reframed = nn.multivariate_ts_to_supervised_extra_lag(values, n_lags, 
	p_out,return_threshold, pct_change_cols)
...
equity_curve_data = nn.equity_curve(out_of_sample_dataset, name,
	periods_in_year, plot, threshold, return_threshold, bayesian_threshold)
